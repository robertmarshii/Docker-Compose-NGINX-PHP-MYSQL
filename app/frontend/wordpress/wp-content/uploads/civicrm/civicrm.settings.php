...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://user:password@192.168.0.74:3308/db?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['wp.frontend.base']['url'] = 'http://127.0.0.1:8081/wordpress/';
$civicrm_paths['wp.backend.base']['url'] = 'http://127.0.0.1:8081/wordpress/wp-admin/';
$civicrm_setting['domain']['userFrameworkResourceURL'] = 'http://127.0.0.1:8081/wordpress/wp-content/plugins/civicrm/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://user:password@192.168.0.74:3308/db?new_link=true');
  }
}
...
$civicrm_root = '/var/www/wordpress/wp-content/plugins/civicrm/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/wordpress/wp-content/uploads/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://127.0.0.1:8081/wordpress');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'I8kGO44bIXaGshfTuP8zxIZelstxmLbZvaYYkuSIwCY');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/wordpress/wp-content/uploads/civicrm/templates_c/mail.log');
// }
